export type MovementId =
  "semi-flat" | "minimalism" | "neumorphism" | "neo-brutalism" | "maximalism"
...
> = {
  ...
  minimalism: {
    id: "minimalism",
    name: "Minimalism",
    container: "space-y-6 font-sans tracking-tight",
    heroCard:
      "relative overflow-hidden border-b border-border/40 bg-transparent p-6 sm:p-8 transition-all duration-300",
    heroGlow: "hidden",
    tileCard:
    ...
    interactiveCard:
      "border-t border-b border-border/40 bg-transparent py-6 px-4 space-y-5 transition-all duration-300",
    buttonPrimary:
    ...
    statValue: "text-5xl font-light tracking-tighter text-foreground",
    typographyLabel:
      "text-[10px] font-mono uppercase tracking-widest text-muted-foreground",
  },
  ...
  "neo-brutalism": {
    ...
    heroCard:
      "relative overflow-hidden rounded-xl border-3 border-foreground bg-card p-6 shadow-[5px_5px_0px_0px_currentColor] text-foreground transition-all duration-200",
    heroGlow:
    ...
    tileCard:
      "flex flex-col justify-between space-y-3 rounded-xl border-3 border-foreground bg-card p-5 shadow-[4px_4px_0px_0px_currentColor] text-foreground transition-all duration-200 hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[6px_6px_0px_0px_currentColor]",
    badge:
    ...
    interactiveCard:
      "rounded-xl border-3 border-foreground bg-card p-5 shadow-[4px_4px_0px_0px_currentColor] text-foreground space-y-4 transition-all duration-200",
    buttonPrimary:
  ...
  maximalism: {
    id: "maximalism",
    name: "Maximalism",
    container: "space-y-3 font-sans tracking-tight",
    heroCard:
      "relative overflow-hidden rounded-none border border-foreground bg-card p-6 text-foreground transition-colors duration-150",
    heroGlow: "hidden",
    tileCard:
      "flex flex-col justify-between space-y-3 rounded-none border border-foreground bg-card p-5 text-foreground transition-colors duration-150 hover:bg-muted/30",
    badge:
      "inline-flex items-center gap-1.5 rounded-none border border-foreground bg-primary px-2.5 py-0.5 text-xs font-bold uppercase tracking-wider text-primary-foreground",
    badgeText:
      "text-[10px] font-mono font-bold uppercase tracking-widest text-foreground",
    interactiveCard:
      "rounded-none border border-foreground bg-card p-5 text-foreground space-y-4 transition-colors duration-150",
    buttonPrimary:
      "w-full rounded-none border border-foreground bg-primary py-2.5 px-4 font-bold text-xs uppercase tracking-wider text-white transition-all duration-150 hover:bg-foreground hover:text-background",
    buttonSecondary:
      "w-full rounded-none border border-foreground bg-card py-2.5 px-4 font-bold text-xs uppercase tracking-wider text-foreground transition-all duration-150 hover:bg-foreground hover:text-background",
    input:
      "w-full rounded-none border border-foreground bg-background px-3 py-2 text-xs font-mono text-foreground placeholder:text-muted-foreground focus:outline-none focus:bg-primary/5",
    accentPill:
      "rounded-none border border-foreground bg-amber-300 dark:bg-amber-400 text-black px-2.5 py-0.5 text-[10px] font-mono font-bold uppercase tracking-widest",
    divider: "border-foreground",
    statValue:
      "text-5xl font-black tracking-tight text-foreground font-sans leading-none",
    typographyLabel:
      "text-[10px] font-mono font-bold uppercase tracking-widest text-foreground",
  },
...
export function getPreviewTheme(
  ...
  if (!movementId || !(movementId in PREVIEW_THEMES)) {
    return PREVIEW_THEMES["semi-flat"]
  }
