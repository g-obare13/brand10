      ...
      <div className="flex h-full flex-col justify-between py-6">
        ...
        <div className="space-y-3 pt-2">
          <div className="space-y-2">
            <h2 className="text-primary-900 uppercase">HEADINGS SCALE</h2>
        ...
        <div className="my-auto space-y-5 py-2">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between border-b border-zinc-200 pb-1.5 text-xs text-zinc-400 uppercase">
            ...
            <div className="space-y-3.5 divide-y divide-zinc-100">
              ...
              <div className="flex items-baseline justify-between gap-4 pt-1">
                <div className="w-24 shrink-0 text-xs font-bold text-zinc-400">
                  H1 Display
                </div>
                <div
                  className="min-w-0 flex-1 truncate font-extrabold tracking-tight text-primary-900"
                  style={{
                ...
                <div className="w-28 shrink-0 text-right text-xs text-zinc-500">
                  {h1Size}px / 1.10
                </div>
              </div>
              ...
              <div className="flex items-baseline justify-between gap-4 pt-3">
                ...
                <div
                  className="min-w-0 flex-1 truncate font-bold tracking-tight text-primary-900"
                  style={{
                    fontFamily: `"${displayFamily}", sans-serif`,
              ...
              <div className="flex items-baseline justify-between gap-4 pt-3">
                ...
                <div
                  className="min-w-0 flex-1 truncate font-semibold tracking-tight text-primary-900"
                  style={{
                    fontFamily: `"${displayFamily}", sans-serif`,
              ...
              <div className="flex items-baseline justify-between gap-4 pt-3">
                ...
                <div
                  className="min-w-0 flex-1 truncate font-semibold text-primary-900"
                  style={{
                    fontFamily: `"${displayFamily}", sans-serif`,
              ...
              <div className="flex items-baseline justify-between gap-4 pt-3">
                ...
                <div
                  className="min-w-0 flex-1 truncate font-medium text-primary-900"
                  style={{
                    fontFamily: `"${displayFamily}", sans-serif`,
