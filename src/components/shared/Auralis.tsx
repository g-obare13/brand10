...
void main() {
  ...
  float light = pow(abs(n2), 2.5) * 0.6; 

  vec3 col = vec3(0.0); 

  col += u_colors[0] * smoothstep(0.1, 1.0, n1) * 0.6;
  col += u_colors[1] * light * 0.7;
  col += u_colors[2] * smoothstep(0.2, 0.8, abs(n2)) * 0.4;
