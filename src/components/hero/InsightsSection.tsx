...
import { insightsSectionData } from "@/data/menu"
...
/**
 * Agency insights / media section.
 * Displays a list of media articles or blog posts with title, author avatar, date,
 * excerpt, and thumbnail image. Uses GSAP for staggered fade-up and parallax animations.
 */
  ...
  return (
    ...
    >
      <Container className="space-y-16">
        <WordReveal
          text={insightsSectionData.title}
          as="h2"
